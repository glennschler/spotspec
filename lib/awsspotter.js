...
*/
AwsSpotter.prototype.prices = function (options) {
  var self = this
  var now = new Date()
...
*/
AwsSpotter.prototype.launch = function launch (options) {
  var self = this
...
* @emits AwsSpotter#priced
*/
AwsSpotter.prototype.describeRequests = function spotDescribe () {
  var self = this
  var params = {
    DryRun: false
  }
...
*/
AwsSpotter.prototype.describeInstances = function describeInstances (options) {
  var self = this
  ...
  req.on('success', function onSuccess (resp) {
    ...
    * @param {?error} err - Only on error
    * @param {AwsSpotter#reservations[]} [instances] - Null on error
    */
