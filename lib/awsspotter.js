...
*/
AwsSpotter.prototype.spotLaunch = function spotLaunch (options) {
  var self = this
...
/**
* spotsDescribe - Describe the status of all current spot requests See [aws docs]{@link http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/EC2.html#describeSpotInstanceRequests-property}
* @arg {object} attributes - JSON attributes to request current price
* @arg {boolean} [attributes.dryRun=true] - Only verify parameters.
* @emits AwsSpotter#priced
*/
AwsSpotter.prototype.spotsDescribe = function spotDescribe () {
  var self = this
  var params = {
    DryRun: false
  }
  ...
  req.on('success', function onSuccess (resp) {
    ...
    /**
    * Emitted as the response to a spotPrices request
    * @event AwsSpotter#instances
    * @param {?error} err - Only on error
    * @param {AwsSpotter#SpotInstanceRequests[]} [SpotInstanceRequests] - Null on error
    */
...
* @arg {object} attributes - JSON attributes to request current price
* @arg {boolean} [attributes.dryRun=true] - Only verify parameters.
* @emits {AwsSpotter#Reservations[]} Array of EC2 instances
*/
AwsSpotter.prototype.instancesDescribe = function instancesDescribe (options) {
  var self = this
  ...
  req.on('success', function onSuccess (resp) {
    ...
    * @event AwsSpotter#instances
    * @param {?error} err - Only on error
    * @param {AwsSpotter#Reservations[]} [instanceReservations] - Null on error
    */
